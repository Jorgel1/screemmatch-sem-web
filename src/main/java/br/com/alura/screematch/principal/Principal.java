...
//            List<DadosEpisodio> eposodiosTemporada = temporadas.get(i).episodios();
//            for (int j = 0; j < eposodiosTemporada.size(); j++) {
//                System.out.println(eposodiosTemporada.get(j).titulo());
//            }
//        }
...
//                .toList() //toList cria uma lista da qual não aceita alterações, uma lista imuntável
                .collect(Collectors.toList());

//        dadosEpisodios.add(new DadosEpisodio("teste", 3, "10", "2018-01-01"));
